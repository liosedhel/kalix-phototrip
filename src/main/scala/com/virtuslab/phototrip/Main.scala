...
import com.virtuslab.phototrip.worldmap.actions.{GetFullMapActionImpl, GetFullMapActionProvider}
...
object Main {
  ...
  def createKalix(): Kalix = {
    Kalix()
      ...
      //actions
      .register(GetFullMapActionProvider(new GetFullMapActionImpl(_)))
  }
